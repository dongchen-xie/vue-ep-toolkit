<template>
  <bk-form
    ...
    label-width="auto"
  >
    <bk-form-item label="Activity name" prop="name">
      <el-input v-model="ruleForm.name" />
    </bk-form-item>
    <bk-form-item label="Activity zone" prop="region">
      <el-select v-model="ruleForm.region" placeholder="Activity zone">
        <el-option label="Zone one" value="shanghai" />
        <el-option label="Zone two" value="beijing" />
      </el-select>
    </bk-form-item>
    <bk-form-item label="Activity count" prop="count">
      <el-select-v2 v-model="ruleForm.count" placeholder="Activity count" :options="options" />
    </bk-form-item>
    <bk-form-item label="Activity time" required>
      <el-col :span="11">
        <bk-form-item prop="date1">
          <el-date-picker
    ...
    <bk-form-item label="Instant delivery" prop="delivery">
      <el-switch v-model="ruleForm.delivery" />
    </bk-form-item>
    <bk-form-item label="Activity location" prop="location">
      <el-segmented v-model="ruleForm.location" :options="locationOptions" />
    </bk-form-item>
    <bk-form-item label="Activity type" prop="type">
    ...
    <bk-form-item label="Resources" prop="resource">
      <el-radio-group v-model="ruleForm.resource">
        <el-radio value="Sponsorship">Sponsorship</el-radio>
        <el-radio value="Venue">Venue</el-radio>
      </el-radio-group>
    </bk-form-item>
    <bk-form-item label="Activity form" prop="desc">
...
const submitForm = async (formEl: FormInstance | undefined) => {
  if (!formEl) return
  await formEl.elFormRef?.validate((valid, fields) => {
    if (valid) {
      console.log("submit!")
    } else {
