...
const OUTPUT_FILE = path.join(__dirname, "../types/global.d.ts")
...
function readComponentTypes(componentDir: string): ComponentInfo | null {
  ...
  // 查找该组件对应的 EpXxxProps（精确匹配）
  // 例如：EpTableProps, EpButtonProps, 但不匹配 EpTableColumnProps
